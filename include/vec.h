...
/**
 * @brief Prints a vector to stdout in the format: vector = < x, y, z >
 *
...
/**
 * @brief Creates a vector with the given components.
 *
...
/**
 * @brief Scales each component of the vector by a scalar.
 *
...
/**
 * @brief Computes the Hadamard product (component-wise multiplication) of two vectors.
 *
 * @param a The first vector.
 * @param b The second vector.
...
/**
 * @brief Creates a vector with random components in the given range.
 *
...
/**
 * @brief Creates a vector with random components in the unit sphere.
 *
...
/**
 * @brief Checks if the vector is near zero (all components are close to zero).
 *
 * @param a The vector.
...
/**
 * @brief Reflects the vector about a normal vector.
 *
...
/**
 * @brief Refracts the vector through a normal vector using Snell's law.
 *
...
/**
 * @brief Creates a vector with random components in the unit disk.
 *
 ...
 * @return A color with the specified components.
 */
